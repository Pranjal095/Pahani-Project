                    ...
                    >
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-4 lg:space-y-0">
                        <div className="flex-1">
                          ...
                          {/* PDF Upload Section for Processed Requests */}
                          {request.processed && !request.pdf_s3_url && (
                            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                              <h4 className="text-sm font-semibold text-blue-900 mb-3">
                                Upload Pahani PDF Document
                              </h4>
                              <div className="flex flex-col sm:flex-row gap-3">
                                <input
                                  type="file"
                                  accept=".pdf"
                                  onChange={(e) => handleFileSelect(request.id, e.target.files[0])}
                                ...
                                />
                                <button
                                  onClick={() => uploadPDF(request.id)}
                                  disabled={!selectedFiles[request.id] || uploadingId === request.id}
